...
| CLOUDABILITY_CLUSTER_NAME                      |                                                            Required: The cluster name to be used for the cluster the agent is running in. Must contain only alphanumeric characters and dashes, no spaces.  |
